...
if(isset($_POST['add_product'])){
   ...
   if($select_product->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(name, price, type, image) VALUES(?,?,?,?)");
         $insert_product->execute([$name, $price, $type, $image]);
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="type"><?= $fetch_products['type']; ?></div> <!-- Hiển thị loại sản phẩm -->
      <div class="flex-btn">
